    ...
    return (
      <div
        ...
        className={cn(
          ...
          variant === "outlined" && "border-border border-2",
          variant === "interactive" &&
            "border-border hover:border-primary/20 cursor-pointer border shadow-sm transition-all duration-200 hover:shadow-md",
          className
        )}
        {...props}
      />
